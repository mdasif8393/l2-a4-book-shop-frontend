    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        <div className="w-full lg:w-5/12 flex flex-col justify-center">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 dark:text-white">
            Book Shop is a premier online bookstore dedicated to bringing
            readers a diverse collection of books across all genres. Our
            platform offers a seamless shopping experience with an extensive
            selection of bestsellers, classics, academic books, and rare finds.
            We provide fast delivery, competitive pricing, and exclusive
            discounts to ensure customer satisfaction. With a user-friendly
            website and secure payment options, we make book shopping convenient
            and enjoyable. Whether you're looking for paperbacks, hardcovers,
            eBooks, or audiobooks, we cater to every reader’s needs. Our mission
            is to promote a love for reading by making books accessible to
            everyone. lifestyle.
          </p>
        </div>
      ...
      <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
        <div className="w-full lg:w-5/12 flex flex-col justify-center">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 dark:text-white">
            Book Shop was founded with a passion for books and a vision to make
            reading accessible to everyone. What started as a small idea soon
            turned into a thriving online bookstore, offering a vast collection
            of titles across multiple genres. We believe in the power of stories
            to inspire, educate, and entertain, which is why we carefully curate
            our selection to suit every reader’s taste. Our journey has been
            fueled by a love for literature and a commitment to providing a
            seamless book-buying experience. As we grow, we remain dedicated to
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9">
                  We’re here to help! For any inquiries, orders, or support,
